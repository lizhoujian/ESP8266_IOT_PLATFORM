#ifndef __USER_ESPSWITCHS_H__
#define __USER_ESPSWITCHS_H__
...
void user_plugs_init(void);
uint8_t user_plugs_count(void);

char *user_plugs_get_status_string(char *s, int len);
void user_plugs_set_status_string(char *s, int len);
...
/* new style */
bool user_plugs_get_status(uint8_t index);
void user_plugs_set_status(uint8_t index, bool status);
